# Skillbox-Capstone-Project
Megafon cell operator client data research

This was the capstone project for Skillbox.ru Data Scientist Profession course (Профессия Data Scientist).
...
Initial data is provided in the megafon.csv file.
